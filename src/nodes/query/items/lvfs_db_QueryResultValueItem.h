...
#ifndef LVFS_DB_QUERYRESULTVALUEITEM_H_
#define LVFS_DB_QUERYRESULTVALUEITEM_H_
...
{
public:
    QueryResultValueItem(const EntityValue &value, Item *parent);
...
#endif /* LVFS_DB_QUERYRESULTVALUEITEM_H_ */
