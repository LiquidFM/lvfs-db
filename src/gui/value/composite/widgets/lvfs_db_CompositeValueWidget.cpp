...
CompositeValueWidgetPrivate::CompositeValueWidgetPrivate(ICallback *callback, EventHandler *handler, const Interface::Adaptor<IStorage> &container, const EntityValue &value) :
    m_callback(callback),
...
MainCompositeValueWidget::MainCompositeValueWidget(EventHandler *handler, const Interface::Adaptor<IStorage> &container, const EntityValue &value, NestedDialog *parent) :
...
CompositeValueWidget::CompositeValueWidget(const Interface::Adaptor<IStorage> &container, const EntityValue &value, NestedDialog *parent, const QString &title) :
