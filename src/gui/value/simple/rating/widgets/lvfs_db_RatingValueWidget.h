...
#ifndef LVFS_DB_RATINGVALUEWIDGET_H_
#define LVFS_DB_RATINGVALUEWIDGET_H_
...
class PLATFORM_MAKE_PRIVATE RatingValueWidgetPrivate : public QWidget
{
    Q_OBJECT
...
#endif /* LVFS_DB_RATINGVALUEWIDGET_H_ */
