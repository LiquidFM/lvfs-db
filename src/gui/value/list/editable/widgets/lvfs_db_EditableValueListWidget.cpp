...
EditableValueListWidgetPrivate::EditableValueListWidgetPrivate(ICallback *callback, EventHandler *handler, const Interface::Adaptor<IStorage> &container, const EntityValueReader &reader) :
    QWidget(),
    m_callback(callback),
...
MainEditableValueListWidget::MainEditableValueListWidget(EventHandler *handler, const Interface::Adaptor<IStorage> &container, const EntityValueReader &reader, NestedDialog *parent) :
...
EditableValueListWidget::EditableValueListWidget(const Interface::Adaptor<IStorage> &container, const EntityValueReader &reader, NestedDialog *parent) :
