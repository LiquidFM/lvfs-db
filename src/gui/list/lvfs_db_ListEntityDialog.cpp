...
#include "lvfs_db_ListEntityDialog.h"
#include "model/items/lvfs_db_EntitiesTreeItem.h"
#include "../create/lvfs_db_CreateEntityDialog.h"

#include <QtGui/QAction>
#include <QtGui/QMessageBox>


ListEntityDialog::ListEntityDialog(const Interface::Adaptor<IStorage> &container, QWidget *parent) :
    QDialog(parent),
